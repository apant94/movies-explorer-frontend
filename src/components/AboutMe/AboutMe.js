...
function AboutMe() {
  ...
  <section className='aboutme'>
    ...
    <div className='aboutme__profile-container'>
      ...
      <p className='aboutme__text'>Я роидлась и живу в Москве, закончила НИУ-ВШЭ и ФА при Правительстве РФ по направлению экономика. У меня есть собачка корги. Я люблю лепить посуду, а ещё у меня в течение 5 лет был свой бренд одежды. Уже больше года занимаюсь кодингом. В процессе прохождения курса по веб-разработке начала заниматься фриланс-заказами и снова обрела горящие глаза и новую себя. Я&nbsp;себе&nbsp;такой&nbsp;нравлюсь&nbsp;:)</p>
      <a className='aboutme__link' href='https://github.com/apant94'>Github</a>
